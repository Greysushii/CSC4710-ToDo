...
const Today: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Todo App Tasks Due Today</title>
        <meta
          name="description"
          content="All Tasks Due Today will be shown on this page."
        />
      ...
      <main className="flex min-h-screen flex-col items-center gap-4 bg-gradient-to-b from-[#2e026d] to-[#15162c] pb-40">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-4">
          <h1 className="text-5xl font-extrabold tracking-tight text-white sm:text-[5rem]">
            Tasks due <span className="text-[hsl(280,100%,70%)]">Today</span>
          </h1>
          <LinksContainer />
        </div>
        ...
        <TasksDisplay dateFilter="today" />
        {/* Create a container for the category list */}
        <CategoriesDisplay dateFilter="today" />
      </main>
    </>
  );
};
